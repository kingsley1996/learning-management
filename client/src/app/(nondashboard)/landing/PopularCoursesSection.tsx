...
const PopularCoursesSection: React.FC<PopularCoursesSectionProps> = ({
  ...
  // Hiển thị section header ngay lập tức, không đợi courses
  const renderSectionHeader = () => (
    <div className="w-[95%] md:w-[85%] m-auto">
      ...
      <p className="text-[16px] font-Poppins relative text-center py-3">
        <span className="dot"></span> Cung cấp những kỹ năng cần thiết cho công
        việc lập trình của bạn
      </p>
      <br />
      <br />
    </div>
  ...
  // Hiển thị courses grid với loading state
  const renderCoursesGrid = () => {
    ...
    if (!courses || courses.length === 0) {
      return (
        <div className="w-[95%] md:w-[85%] m-auto text-center py-16">
